...
| **src/constants.py**               | ESCI gains, DATA_DIR, MODEL_CACHE_DIR, DEFAULT_RERANKER_MODEL.                                 |
...
| **src/training/train_reranker.py** | Training entrypoint: load data, build dataloader, fit CrossEncoder, final test eval.           |
